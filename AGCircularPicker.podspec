...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AGCircularPicker.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/savilov/AGCircularPicker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'savilov' => 'sergii.avilov@agilie.com' }
  s.source           = { :git => 'https://github.com/savilov/AGCircularPicker.git', :tag => s.version.to_s }
